...
enum Config {
	...
	TXDSTORESIZE = 2800, // 1385 in miami
	COLSTORESIZE = 100, // 31 in miami
	EXTRADIRSIZE = 512, // 256 in miami
	CUTSCENEDIRSIZE = 1024, // 512 in miami

	SIMPLEMODELSIZE = 7770, // 2*3885 miami
	TIMEMODELSIZE = 770, // 2*385 miami
	CLUMPMODELSIZE = 5,
	WEAPONMODELSIZE = 37,
	PEDMODELSIZE = 130,
	VEHICLEMODELSIZE = 110,
	TWODFXSIZE = 2420, // 2*1210 miami
	...
	// Pool sizes
	NUMPTRNODES = 50000,
	NUMENTRYINFOS = 5000, // 3200 in miami
	NUMPEDS = 140,
	NUMVEHICLES = 110,
	NUMBUILDINGS = 7000,
	NUMTREADABLES = 1,
	...
	NUMCOLMODELS = 8800, // 4400 in miami
